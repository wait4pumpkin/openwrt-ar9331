...
#define UPNP_TYPE_CONNECTION_MANAGER_SERVICE (upnpConnectionManagerService_get_type())
#define UPNP_CONNECTION_MANAGER_SERVICE(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), UPNP_TYPE_CONNECTION_MANAGER_SERVICE, UpnpConnectionManagerService))
#define UPNP_IS_CONNECTION_MANAGER_SERVICE(obj) G_TYPE_CHECK_INSTANCE_TYPE((obj), UPNP_TYPE_CONNECTION_MANAGER_SERVICE))
#define UPNP_CONNECTION_MANAGER_SERVICE_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), UPNP_TYPE_CONNECTION_MANAGER_SERVICE, UpnpConnectionManagerServiceClass))
