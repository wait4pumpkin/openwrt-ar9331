...
#define UPNP_AVTRANSPORT_SERVICE(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), \
			UPNP_TYPE_AVTRANSPORT_SERVICE, UpnpAVTransportService))
#define UPNP_IS_AVTRANSPORT_SERVICE(obj) G_TYPE_CHECK_INSTANCE_TYPE((obj), UPNP_TYPE_AVTRANSPORT_SERVICE))
#define UPNP_AVTRANSPORT_SERVICE_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), \
			UPNP_TYPE_AVTRANSPORT_SERVICE, UpnpAVTransportServiceClass))
#define UPNP_IS_AVTRANSPORT_SERVICE_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), UPNP_AVTRANSPORT_SERVICE))
#define UPNP_AVTRANSPORT_SERVICE_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj), \
			UPNP_TYPE_AVTRANSPORT_SERVICE, UpnpAVTransportServiceClass))
